...
#define LAYOUT_helix_base( \
  ...
  KC_TAB , K21, K22, K23, K24, K25,                                                     K26, K27, K28, K29, K2A, K2B, \
  L2_WIDE, K31, K32, K33, K34, K35, KC_CAPS,                                    KC_F24, K36, K37, K38, K39, K3A, R3_WIDE, \
  L3_WIDE, KC_HOME, WIDE_THUMB_L1, __________________THUMB_L1_________________, __________________THUMB_R1_________________, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT \
  )
/* Re-pass though to allow templates to be used */
#define LAYOUT_base_wrapper(...)       LAYOUT_helix_base(__VA_ARGS__)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______________NAV_THUMB_L1________________, _______________NAV_THUMB_R1________________, _______, _______, _______, MO(_GAME)
    ...
    [_SYM] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______________SYM_THUMB_L1________________, _______________SYM_THUMB_R1________________, _______, _______, _______, _______
    ),
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______________FUNC_THUMB_L1_______________, _______________FUNC_THUMB_R1_______________, NUM_EXTRA, _______, _______
    ),
    [_ADJUST] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______________ADJ_THUMB_L1________________, _______________ADJ_THUMB_R1________________, _______, _______, _______, _______
    ),
    [_GAME] = LAYOUT_wrapper(
        ...
        KC_TAB , _________________QWERTY_L2_________________,                                     _______, __________________NUM_R2___________________,
        L2_WIDE, _________________QWERTY_L3_________________, _______,                   _______, KC_UP  , __________________NUM_R3___________________,
        L3_WIDE, KC_HOME, _______, KC_DEL , __________________THUMB_L1_________________, KC_LEFT, KC_DOWN, KC_RIGHT, NUM_EXTRA, _______, _______
    )
};
